...
A connected set of projects demonstrating an end-to-end analytics pipeline:

- **Amplitude API Extraction (Bronze)**  
  https://github.com/Jaffulee/deng3-amplitude

- **Mailchimp API Extraction (Bronze)**  
  https://github.com/Jaffulee/deng3-mailchimp

- **dbt Analytics Layer (Silver–Gold)**  
  https://github.com/Jaffulee/dbt-cloud-deng3

- **TfL Bike Points API** — lightweight ingestion example  
  https://github.com/Jaffulee/Bike-points-api

---

## Writing & Research
- Blog: https://www.thedataschool.co.uk/blog/jeffrey-brian-thompson/  
- Essay: *The Hodge Decomposition Theorem* (Cambridge Part III)  
  https://github.com/Jaffulee/LaTeX-The-Hodge-Decomposition-Theorem-Essay
...
- **A-Level Mathematics Supplementary Materials (PDF)**  
  https://github.com/Jaffulee/Edexcel-A-Level-Maths-Tutoring-Materials
